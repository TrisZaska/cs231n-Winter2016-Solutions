...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    W2 = np.concatenate((b2, W2), axis=0)
  ...
  def predict(self, X):
    ...
    ###########################################################################
    X = np.concatenate((np.ones((X.shape[0], 1)), X), axis=1)
    W1 = np.concatenate((self.params['b1'], self.params['W1']), axis=0)
    
    z1 = X.dot(W1)
    a1 = np.maximum(0, z1)
    
    a1 = np.concatenate((np.ones((a1.shape[0], 1)), a1), axis=1)
    W2 = np.concatenate((self.params['b2'], self.params['W2']), axis=0)
    scores = a1.dot(W2)
